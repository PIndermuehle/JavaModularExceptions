...
public final class helloify implements Constants {
    ...
    public static void main(String[] argv) throws Exception {
        argv = new String[1];
    	argv[0] = System.getProperty("user.dir")+File.separator+"bin"+File.separator+"TestSubject.class";
    	...
    	for (String arg : argv) {
            if (arg.endsWith(".class")) {
            	...
            	// get the class and constants in parser form
                JavaClass java_class = new ClassParser(arg).parse();
                ConstantPool constants = java_class.getConstantPool();
                // create new classname for the changed class
                String file_name = arg;
                //file_name = arg.substring(0, arg.length() - 6) + "_hello.class";
